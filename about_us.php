...
<head>
    ...
    <link rel="apple-touch-icon" sizes="274x184" href="statics/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="274x184" href="statics/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="274x184" href="statics/favicon-16x16.png">
    ...
    <title>About us - standard Bank</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>

<body style="background-color:#68A063;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/nishit.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:blue;">This website is created by</p>
            <h1 style="color:blue; text-shadow:2px 2px 2px gray;">NISHIT PATEL</h1>
            <p style="color:blue;"><b>Intern at Sparks Foundation <br>ldrp institute of technology and research,gandhinagar</b></p>
    </center>
